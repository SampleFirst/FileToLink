...
async def maintainers(b, m):
    try:
        ...
        await b.send_message(
            chat_id=m.chat.id,
            text="I am Coded By [None]",
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("Developer 💻", url="https://t.me/iPepkornUpdate")]
                ]
            ),
...
async def follow_user(b, m):
    try:
        ...
        await b.send_message(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("FOLLOW ME", url="https://t.me/iPepkornUpdate")]
                ]
            ),
            disable_web_page_preview=True
        )
...
async def list_commands(l, m):
    LIST_MSG = (
        ...
        "5. /ping = `ping📡`\n"
        "6. /status = `status📊`\n"
        "7. /dc = `DC` this tells your telegram dc\n"
...
@StreamBot.on_message(filters.private & filters.command("status") | filters.regex("status📊"))
